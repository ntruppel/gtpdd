...
for score in last_scores:
    ...
    awayName,homeName,away_df,home_df = getBoxScore(score,platform,'batter')
...
start_w = l_gap
start_h = t_gap
colors = ['pinstripe','white','blue','red','sky']
...
logo = Image.open(r'in_files/team_logos/' + opponent + '.png')
...
###
if color == 'blue':
    single = Image.open('/tmp/bsbScorecardSingle/bsbScorecardSingleBlue.jpg')
    textColor = 'black'
    errColor = '#A20000'
elif color == 'gray':
    single = Image.open('/tmp/bsbScorecardSingle/bsbScorecardSingleGrey.jpg')
    textColor = '#2C4997'
    errColor = '#A20000'
elif color == 'red':
    single = Image.open('/tmp/bsbScorecardSingle/bsbScorecardSingleRed.jpg')
    textColor = '#2C4997'
    errColor = '#A20000'
elif color == 'sky':
    single = Image.open('/tmp/bsbScorecardSingle/bsbScorecardSingleSky.jpg')
    textColor = 'black'
    errColor = '#A20000'
elif color == 'white':
    single = Image.open('/tmp/bsbScorecardSingle/bsbScorecardSingleWhite.jpg')
    textColor = '#2C4997'
    errColor = '#A20000'
elif color == 'pinstripe':
    single = Image.open('/tmp/bsbScorecardSingle/bsbScorecardSinglePinstripe.jpg')
    textColor = '#2C4997'
    errColor = '#A20000'
...
for row in play_list:
    ...
    ## Everything remaining is a batting play
        ...
        w1, h1 = card_draw.textsize(row['Play'], font=play_font)
        x = (sw - 15 - w1)/2 + w + 15
        y = (sh - 35 - h1)/2 + h + 35
